...
SECRET_KEY = 'django-insecure-ojdp+ofr+gj8x+q4ds(7ns*efe^k9s2&=%@h+t2$1huuluwz^8'
...
# Razorpay API Keys
RAZORPAY_KEY_ID = "rzp_test_CkjkBHB3TQcyK1"
RAZORPAY_KEY_SECRET = "957PvH2KL5XJfprjQ3eeCZIM"
...
admin_login_required = user_passes_test(is_admin, login_url='/login/')
